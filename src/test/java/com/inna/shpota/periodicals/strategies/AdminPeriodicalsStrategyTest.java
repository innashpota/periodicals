...
public class AdminPeriodicalsStrategyTest {
    ...
    public void shouldHandle() throws ServletException, IOException {
        ...
        Admin admin = admin();
        prepareMock(adminDao, request, session, admin);
    ...
    public void shouldHandleRedirect() throws ServletException, IOException {
        ...
        HttpServletResponse response = mock(HttpServletResponse.class);
        HttpSession session = mock(HttpSession.class);
        prepareMock(adminDao, request, session, null);
    ...
    private void prepareMock(AdminDao adminDao, HttpServletRequest request, HttpSession session, Admin admin) {
